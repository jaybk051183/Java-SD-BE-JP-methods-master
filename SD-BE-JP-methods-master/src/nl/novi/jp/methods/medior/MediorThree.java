...
public class MediorThree {
    ...
    public static void printName(String firstName, String lastName) {
        String firstNameToUpperCase = firstLetterToUpperCase(firstName);
        String lastNameToUpperCase = firstLetterToUpperCase(lastName);

        System.out.println("Naam: " + firstNameToUpperCase + " " +  lastNameToUpperCase);
